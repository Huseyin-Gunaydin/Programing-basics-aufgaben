...
// - Lege die Property lastName in einer Variable ab und gib ihr den default Wert `"empt"”`. Wenn es eine Property `lastName` im Objekt Person gibt soll sie verwendet werden.
// ```js
const person = {
    name: "Tom",
    email: "tom@gmx.de",
...
const [erstesElement,zweitesElement] = names
const [,, ...rest]=names
console.log(erstesElement, zweitesElement, rest)
